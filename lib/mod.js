...
let __createClass = (Super, xmlns) => {
	function Element(name, ...args) {
		...
		element = set(
			document.createElementNS('http://www.w3.org/' + xmlns, name, ...args),
			...args
		)
...
export let HTML = __createClass(globalThis.HTMLElement, '1999/xhtml')
export let MathML = __createClass(globalThis.MathMLElement, '1998/Math/MathML')
export let SVG = __createClass(globalThis.SVGElement, '2000/svg')
