...
export interface feColorMatrix extends Partial<Pick<AllAttributes, 'in'>
/**
 ...
 */
 & GetValues & GetType<'FeColorMatrix'> & SVGGenericAttributes & SVGFilterPrimitiveAttributes & SVGPresentationAttributes> {
}
